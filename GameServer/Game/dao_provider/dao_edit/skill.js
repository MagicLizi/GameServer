...
apple.addSkill = function (model, callback) {
    var sql = new sqlCommand('INSERT INTO edit_skill(Skill_Name,Skill_Type,Need_Target,Skill_Use_Range,Skill_Effect_Range,' +
            ...
            'Skill_Effect,Skill_Target_Type, Create_Date) ' +
            'VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)',
        [model.Skill_Name,model.Skill_Type,model.Need_Target,model.Skill_Use_Range,model.Skill_Effect_Range,
            ...
            model.Skill_Particle_Url,model.Skill_Tag,model.Skill_Effect,model.Skill_Target_Type,model.Create_Date]);
...
apple.editSkill = function (model, callback) {
    var sql = new sqlCommand('UPDATE edit_skill SET Skill_Name = ?,Skill_Type = ?,Need_Target = ?,Skill_Use_Range = ?,' +
            ...
            'Skill_Particle_Url = ?, Skill_Tag = ?,Skill_Effect_Range = ?,Skill_Effect = ?,Skill_Target_Type = ? WHERE Skill_Id=?',
            [model.Skill_Name,model.Skill_Type,model.Need_Target,model.Skill_Use_Range,model.Energy_Expends,
            model.Target_Num,model.Skill_Description,model.Duration_Rounds,model.Skill_Icon_Url,
            model.Skill_Particle_Url,model.Skill_Tag,model.Skill_Effect_Range,model.Skill_Effect,model.Skill_Target_Type,model.Skill_Id]);
